...
import { AnnotationListResponseAnnotationsInnerUser } from './annotation-list-response-annotations-inner-user';

/**
 * 
 * @export
 * @interface AnnotationListResponseAnnotationsInner
 */
export interface AnnotationListResponseAnnotationsInner {
    /**
     * 
     * @type {string}
     * @memberof AnnotationListResponseAnnotationsInner
     */
    'id'?: string;
    /**
     * 
    ...
    /**
     * 
     * @type {AnnotationListResponseAnnotationsInnerUser}
     * @memberof AnnotationListResponseAnnotationsInner
     */
    'user'?: AnnotationListResponseAnnotationsInnerUser;
}
