 ...
 * 
 * @export
 * @interface SourceGetCustomerDetailsResponseCustomerCurrentPlansInnerAmountsInner
 */
export interface SourceGetCustomerDetailsResponseCustomerCurrentPlansInnerAmountsInner {
    /**
     * 
     * @type {string}
     * @memberof SourceGetCustomerDetailsResponseCustomerCurrentPlansInnerAmountsInner
     */
    'currency'?: string;
    /**
     * 
