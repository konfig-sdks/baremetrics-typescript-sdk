...
import { UserGetUserByIdResponseUser } from './user-get-user-by-id-response-user';

/**
 * 
 * @export
 * @interface UserGetUserByIdResponse
 */
export interface UserGetUserByIdResponse {
    /**
     * 
     * @type {UserGetUserByIdResponseUser}
     * @memberof UserGetUserByIdResponse
     */
