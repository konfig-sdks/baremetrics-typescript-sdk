...
import { MetricShowSummaryResponseMetricsInner } from './metric-show-summary-response-metrics-inner';

/**
 * 
 * @export
 * @interface MetricShowSummaryResponse
 */
export interface MetricShowSummaryResponse {
    /**
     * 
     * @type {Array<MetricShowSummaryResponseMetricsInner>}
     * @memberof MetricShowSummaryResponse
     */
    'metrics'?: Array<MetricShowSummaryResponseMetricsInner>;
}
