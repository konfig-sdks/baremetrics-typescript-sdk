 ...
 * 
 * @export
 * @interface SourceGetPlansListResponsePlansInnerAmountsInner
 */
export interface SourceGetPlansListResponsePlansInnerAmountsInner {
    /**
     * 
     * @type {string}
     * @memberof SourceGetPlansListResponsePlansInnerAmountsInner
     */
    'currency'?: string;
    /**
     * 
