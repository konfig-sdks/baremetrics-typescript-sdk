...
import { SourceUpdateCustomerInformationResponseCustomer } from './source-update-customer-information-response-customer';

/**
 * 
 * @export
 * @interface SourceUpdateCustomerInformationResponse
 */
export interface SourceUpdateCustomerInformationResponse {
    /**
     * 
     * @type {SourceUpdateCustomerInformationResponseCustomer}
     * @memberof SourceUpdateCustomerInformationResponse
     */
