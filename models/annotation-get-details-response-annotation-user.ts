 ...
 * 
 * @export
 * @interface AnnotationGetDetailsResponseAnnotationUser
 */
export interface AnnotationGetDetailsResponseAnnotationUser {
    /**
     * 
     * @type {string}
     * @memberof AnnotationGetDetailsResponseAnnotationUser
     */
    'id'?: string;
    /**
     * 
