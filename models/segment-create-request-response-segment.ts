...
import { SegmentCreateRequestResponseSegmentQueryInner } from './segment-create-request-response-segment-query-inner';

/**
 * 
 * @export
 * @interface SegmentCreateRequestResponseSegment
 */
export interface SegmentCreateRequestResponseSegment {
    /**
     * 
     * @type {string}
     * @memberof SegmentCreateRequestResponseSegment
     */
    'id'?: string;
    /**
     * 
    ...
    /**
     * 
     * @type {Array<SegmentCreateRequestResponseSegmentQueryInner>}
     * @memberof SegmentCreateRequestResponseSegment
     */
    'query'?: Array<SegmentCreateRequestResponseSegmentQueryInner>;
    /**
     * 
     * @type {number}
     * @memberof SegmentCreateRequestResponseSegment
