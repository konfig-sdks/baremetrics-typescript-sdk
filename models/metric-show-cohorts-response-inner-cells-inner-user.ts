 ...
 * 
 * @export
 * @interface MetricShowCohortsResponseInnerCellsInnerUser
 */
export interface MetricShowCohortsResponseInnerCellsInnerUser {
    /**
     * 
     * @type {number}
     * @memberof MetricShowCohortsResponseInnerCellsInnerUser
     */
    'total'?: number;
    /**
     * 
