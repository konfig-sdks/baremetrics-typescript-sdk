...
import { SourceGetPlanResponsePlanAmountsInner } from './source-get-plan-response-plan-amounts-inner';

/**
 * 
 * @export
 * @interface SourceGetPlanResponsePlan
 */
export interface SourceGetPlanResponsePlan {
    /**
     * 
     * @type {string}
     * @memberof SourceGetPlanResponsePlan
     */
    'oid'?: string;
    /**
     * 
    ...
    /**
     * 
     * @type {Array<SourceGetPlanResponsePlanAmountsInner>}
     * @memberof SourceGetPlanResponsePlan
     */
    'amounts'?: Array<SourceGetPlanResponsePlanAmountsInner>;
}
