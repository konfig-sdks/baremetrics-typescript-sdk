...
import { SourceCreateSubscriptionResponseEventInfo } from './source-create-subscription-response-event-info';

/**
 * 
 * @export
 * @interface SourceCreateSubscriptionResponseEvent
 */
export interface SourceCreateSubscriptionResponseEvent {
    /**
     * 
     * @type {SourceCreateSubscriptionResponseEventInfo}
     * @memberof SourceCreateSubscriptionResponseEvent
     */
