...
import { GoalGetListResponseGoalsInner } from './goal-get-list-response-goals-inner';

/**
 * 
 * @export
 * @interface GoalGetListResponse
 */
export interface GoalGetListResponse {
    /**
     * 
     * @type {Array<GoalGetListResponseGoalsInner>}
     * @memberof GoalGetListResponse
     */
    'goals'?: Array<GoalGetListResponseGoalsInner>;
}
