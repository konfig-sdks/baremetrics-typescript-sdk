...
import { SourceCreatePlanResponsePlan } from './source-create-plan-response-plan';

/**
 * 
 * @export
 * @interface SourceCreatePlanResponse
 */
export interface SourceCreatePlanResponse {
    /**
     * 
     * @type {SourceCreatePlanResponsePlan}
     * @memberof SourceCreatePlanResponse
     */
