...
import { SourceCancelSubscriptionResponseEvent } from './source-cancel-subscription-response-event';

/**
 * 
 * @export
 * @interface SourceCancelSubscriptionResponse
 */
export interface SourceCancelSubscriptionResponse {
    /**
     * 
     * @type {SourceCancelSubscriptionResponseEvent}
     * @memberof SourceCancelSubscriptionResponse
     */
