...
import { SourceUpdateSubscriptionResponseEventInfo } from './source-update-subscription-response-event-info';

/**
 * 
 * @export
 * @interface SourceUpdateSubscriptionResponseEvent
 */
export interface SourceUpdateSubscriptionResponseEvent {
    /**
     * 
     * @type {SourceUpdateSubscriptionResponseEventInfo}
     * @memberof SourceUpdateSubscriptionResponseEvent
     */
