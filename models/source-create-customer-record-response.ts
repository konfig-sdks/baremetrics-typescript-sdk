...
import { SourceCreateCustomerRecordResponseCustomer } from './source-create-customer-record-response-customer';

/**
 * 
 * @export
 * @interface SourceCreateCustomerRecordResponse
 */
export interface SourceCreateCustomerRecordResponse {
    /**
     * 
     * @type {SourceCreateCustomerRecordResponseCustomer}
     * @memberof SourceCreateCustomerRecordResponse
     */
