...
import { GoalGetByIdResponseGoal } from './goal-get-by-id-response-goal';

/**
 * 
 * @export
 * @interface GoalGetByIdResponse
 */
export interface GoalGetByIdResponse {
    /**
     * 
     * @type {GoalGetByIdResponseGoal}
     * @memberof GoalGetByIdResponse
     */
