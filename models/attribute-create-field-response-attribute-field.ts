 ...
 * 
 * @export
 * @interface AttributeCreateFieldResponseAttributeField
 */
export interface AttributeCreateFieldResponseAttributeField {
    /**
     * 
     * @type {string}
     * @memberof AttributeCreateFieldResponseAttributeField
     */
    'title'?: string;
    /**
     * 
