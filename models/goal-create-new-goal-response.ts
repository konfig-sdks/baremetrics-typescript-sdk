...
import { GoalCreateNewGoalResponseGoal } from './goal-create-new-goal-response-goal';

/**
 * 
 * @export
 * @interface GoalCreateNewGoalResponse
 */
export interface GoalCreateNewGoalResponse {
    /**
     * 
     * @type {GoalCreateNewGoalResponseGoal}
     * @memberof GoalCreateNewGoalResponse
     */
