...
import { AnnotationCreateNewResponseAnnotation } from './annotation-create-new-response-annotation';

/**
 * 
 * @export
 * @interface AnnotationCreateNewResponse
 */
export interface AnnotationCreateNewResponse {
    /**
     * 
     * @type {AnnotationCreateNewResponseAnnotation}
     * @memberof AnnotationCreateNewResponse
     */
