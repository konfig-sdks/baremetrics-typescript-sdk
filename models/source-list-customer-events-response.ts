...
import { SourceListCustomerEventsResponseEventsInner } from './source-list-customer-events-response-events-inner';

/**
 * 
 * @export
 * @interface SourceListCustomerEventsResponse
 */
export interface SourceListCustomerEventsResponse {
    /**
     * 
     * @type {Array<SourceListCustomerEventsResponseEventsInner>}
     * @memberof SourceListCustomerEventsResponse
     */
    'events'?: Array<SourceListCustomerEventsResponseEventsInner>;
}
