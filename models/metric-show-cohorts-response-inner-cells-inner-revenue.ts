 ...
 * 
 * @export
 * @interface MetricShowCohortsResponseInnerCellsInnerRevenue
 */
export interface MetricShowCohortsResponseInnerCellsInnerRevenue {
    /**
     * 
     * @type {number}
     * @memberof MetricShowCohortsResponseInnerCellsInnerRevenue
     */
    'total'?: number;
    /**
     * 
