...
import { SegmentFindWithoutSaveResponseCustomersInner } from './segment-find-without-save-response-customers-inner';

/**
 * 
 * @export
 * @interface SegmentFindWithoutSaveResponse
 */
export interface SegmentFindWithoutSaveResponse {
    /**
     * 
     * @type {Array<SegmentFindWithoutSaveResponseCustomersInner>}
     * @memberof SegmentFindWithoutSaveResponse
     */
    'customers'?: Array<SegmentFindWithoutSaveResponseCustomersInner>;
}
