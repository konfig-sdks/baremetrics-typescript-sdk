...
import { SourceUpdateSubscriptionResponseEvent } from './source-update-subscription-response-event';

/**
 * 
 * @export
 * @interface SourceUpdateSubscriptionResponse
 */
export interface SourceUpdateSubscriptionResponse {
    /**
     * 
     * @type {SourceUpdateSubscriptionResponseEvent}
     * @memberof SourceUpdateSubscriptionResponse
     */
