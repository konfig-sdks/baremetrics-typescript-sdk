 ...
 * 
 * @export
 * @interface AttributeGetFieldsResponseAttributeFieldsInner
 */
export interface AttributeGetFieldsResponseAttributeFieldsInner {
    /**
     * 
     * @type {string}
     * @memberof AttributeGetFieldsResponseAttributeFieldsInner
     */
    'title'?: string;
    /**
     * 
