...
import { EventCreateInsightEventResponseEvent } from './event-create-insight-event-response-event';

/**
 * 
 * @export
 * @interface EventCreateInsightEventResponse
 */
export interface EventCreateInsightEventResponse {
    /**
     * 
     * @type {EventCreateInsightEventResponseEvent}
     * @memberof EventCreateInsightEventResponse
     */
