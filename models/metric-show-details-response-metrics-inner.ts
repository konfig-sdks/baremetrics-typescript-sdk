...
import { MetricShowDetailsResponseMetricsInnerPrevious } from './metric-show-details-response-metrics-inner-previous';

/**
 * 
 * @export
 * @interface MetricShowDetailsResponseMetricsInner
 */
export interface MetricShowDetailsResponseMetricsInner {
    /**
     * 
     * @type {number}
     * @memberof MetricShowDetailsResponseMetricsInner
     */
    'date'?: number;
    /**
     * 
    ...
    /**
     * 
     * @type {MetricShowDetailsResponseMetricsInnerPrevious}
     * @memberof MetricShowDetailsResponseMetricsInner
     */
    'previous'?: MetricShowDetailsResponseMetricsInnerPrevious;
}
