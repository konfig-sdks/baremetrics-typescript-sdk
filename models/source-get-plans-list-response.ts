...
import { SourceGetPlansListResponsePlansInner } from './source-get-plans-list-response-plans-inner';

/**
 * 
 * @export
 * @interface SourceGetPlansListResponse
 */
export interface SourceGetPlansListResponse {
    /**
     * 
     * @type {Array<SourceGetPlansListResponsePlansInner>}
     * @memberof SourceGetPlansListResponse
     */
    'plans'?: Array<SourceGetPlansListResponsePlansInner>;
}
