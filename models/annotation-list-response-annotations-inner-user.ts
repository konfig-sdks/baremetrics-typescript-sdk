 ...
 * 
 * @export
 * @interface AnnotationListResponseAnnotationsInnerUser
 */
export interface AnnotationListResponseAnnotationsInnerUser {
    /**
     * 
     * @type {string}
     * @memberof AnnotationListResponseAnnotationsInnerUser
     */
    'id'?: string;
    /**
     * 
