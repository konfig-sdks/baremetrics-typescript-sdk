...
import { MetricShowCohortsResponseInnerCellsInnerRevenue } from './metric-show-cohorts-response-inner-cells-inner-revenue';
import { MetricShowCohortsResponseInnerCellsInnerUser } from './metric-show-cohorts-response-inner-cells-inner-user';

/**
 * 
 * @export
 * @interface MetricShowCohortsResponseInnerCellsInner
 */
export interface MetricShowCohortsResponseInnerCellsInner {
    /**
     * 
     * @type {string}
     * @memberof MetricShowCohortsResponseInnerCellsInner
     */
    'end'?: string;
    /**
     * 
     * @type {MetricShowCohortsResponseInnerCellsInnerUser}
     * @memberof MetricShowCohortsResponseInnerCellsInner
     */
    'user'?: MetricShowCohortsResponseInnerCellsInnerUser;
    /**
     * 
     * @type {string}
     * @memberof MetricShowCohortsResponseInnerCellsInner
    ...
    /**
     * 
     * @type {MetricShowCohortsResponseInnerCellsInnerRevenue}
     * @memberof MetricShowCohortsResponseInnerCellsInner
     */
    'revenue'?: MetricShowCohortsResponseInnerCellsInnerRevenue;
}
