 ...
 * 
 * @export
 * @interface SourceUpdateCustomerInformationResponseCustomerCurrentPlansInnerAmountsInner
 */
export interface SourceUpdateCustomerInformationResponseCustomerCurrentPlansInnerAmountsInner {
    /**
     * 
     * @type {string}
     * @memberof SourceUpdateCustomerInformationResponseCustomerCurrentPlansInnerAmountsInner
     */
    'currency'?: string;
    /**
     * 
