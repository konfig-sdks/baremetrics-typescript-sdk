 ...
 * 
 * @export
 * @interface SegmentGetFieldsResponseBaremetricsInner
 */
export interface SegmentGetFieldsResponseBaremetricsInner {
    /**
     * 
     * @type {string}
     * @memberof SegmentGetFieldsResponseBaremetricsInner
     */
    'title'?: string;
    /**
     * 
