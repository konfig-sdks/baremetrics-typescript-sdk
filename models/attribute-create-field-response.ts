...
import { AttributeCreateFieldResponseAttributeField } from './attribute-create-field-response-attribute-field';

/**
 * 
 * @export
 * @interface AttributeCreateFieldResponse
 */
export interface AttributeCreateFieldResponse {
    /**
     * 
     * @type {AttributeCreateFieldResponseAttributeField}
     * @memberof AttributeCreateFieldResponse
     */
