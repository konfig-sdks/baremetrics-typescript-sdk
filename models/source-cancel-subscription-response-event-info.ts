 ...
 * 
 * @export
 * @interface SourceCancelSubscriptionResponseEventInfo
 */
export interface SourceCancelSubscriptionResponseEventInfo {
    /**
     * 
     * @type {number}
     * @memberof SourceCancelSubscriptionResponseEventInfo
     */
    'canceled_at'?: number;
    /**
     * 
