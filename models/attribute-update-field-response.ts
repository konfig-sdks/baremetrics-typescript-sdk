...
import { AttributeUpdateFieldResponseAttributeFields } from './attribute-update-field-response-attribute-fields';

/**
 * 
 * @export
 * @interface AttributeUpdateFieldResponse
 */
export interface AttributeUpdateFieldResponse {
    /**
     * 
     * @type {AttributeUpdateFieldResponseAttributeFields}
     * @memberof AttributeUpdateFieldResponse
     */
