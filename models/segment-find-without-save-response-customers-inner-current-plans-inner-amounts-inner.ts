 ...
 * 
 * @export
 * @interface SegmentFindWithoutSaveResponseCustomersInnerCurrentPlansInnerAmountsInner
 */
export interface SegmentFindWithoutSaveResponseCustomersInnerCurrentPlansInnerAmountsInner {
    /**
     * 
     * @type {string}
     * @memberof SegmentFindWithoutSaveResponseCustomersInnerCurrentPlansInnerAmountsInner
     */
    'currency'?: string;
    /**
     * 
