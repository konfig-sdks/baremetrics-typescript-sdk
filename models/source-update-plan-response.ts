...
import { SourceUpdatePlanResponsePlan } from './source-update-plan-response-plan';

/**
 * 
 * @export
 * @interface SourceUpdatePlanResponse
 */
export interface SourceUpdatePlanResponse {
    /**
     * 
     * @type {SourceUpdatePlanResponsePlan}
     * @memberof SourceUpdatePlanResponse
     */
