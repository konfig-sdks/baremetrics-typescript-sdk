 ...
 * 
 * @export
 * @interface SourceUpdatePlanResponsePlanAmountsInner
 */
export interface SourceUpdatePlanResponsePlanAmountsInner {
    /**
     * 
     * @type {string}
     * @memberof SourceUpdatePlanResponsePlanAmountsInner
     */
    'currency'?: string;
    /**
     * 
