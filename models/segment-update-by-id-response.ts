...
import { SegmentUpdateByIdResponseSegment } from './segment-update-by-id-response-segment';

/**
 * 
 * @export
 * @interface SegmentUpdateByIdResponse
 */
export interface SegmentUpdateByIdResponse {
    /**
     * 
     * @type {SegmentUpdateByIdResponseSegment}
     * @memberof SegmentUpdateByIdResponse
     */
