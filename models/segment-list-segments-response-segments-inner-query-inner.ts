 ...
 * 
 * @export
 * @interface SegmentListSegmentsResponseSegmentsInnerQueryInner
 */
export interface SegmentListSegmentsResponseSegmentsInnerQueryInner {
    /**
     * 
     * @type {string}
     * @memberof SegmentListSegmentsResponseSegmentsInnerQueryInner
     */
    'category'?: string;
    /**
     * 
