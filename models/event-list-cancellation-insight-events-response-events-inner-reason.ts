 ...
 * 
 * @export
 * @interface EventListCancellationInsightEventsResponseEventsInnerReason
 */
export interface EventListCancellationInsightEventsResponseEventsInnerReason {
    /**
     * 
     * @type {string}
     * @memberof EventListCancellationInsightEventsResponseEventsInnerReason
     */
    'id'?: string;
    /**
     * 
