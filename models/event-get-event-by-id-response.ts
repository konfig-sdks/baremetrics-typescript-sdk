...
import { EventGetEventByIdResponseEvent } from './event-get-event-by-id-response-event';

/**
 * 
 * @export
 * @interface EventGetEventByIdResponse
 */
export interface EventGetEventByIdResponse {
    /**
     * 
     * @type {EventGetEventByIdResponseEvent}
     * @memberof EventGetEventByIdResponse
     */
