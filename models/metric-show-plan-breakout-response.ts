...
import { MetricShowPlanBreakoutResponseMetricsInner } from './metric-show-plan-breakout-response-metrics-inner';

/**
 * 
 * @export
 * @interface MetricShowPlanBreakoutResponse
 */
export interface MetricShowPlanBreakoutResponse {
    /**
     * 
     * @type {Array<MetricShowPlanBreakoutResponseMetricsInner>}
     * @memberof MetricShowPlanBreakoutResponse
     */
    'metrics'?: Array<MetricShowPlanBreakoutResponseMetricsInner>;
}
