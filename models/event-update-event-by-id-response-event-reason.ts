 ...
 * 
 * @export
 * @interface EventUpdateEventByIdResponseEventReason
 */
export interface EventUpdateEventByIdResponseEventReason {
    /**
     * 
     * @type {string}
     * @memberof EventUpdateEventByIdResponseEventReason
     */
    'id'?: string;
    /**
     * 
