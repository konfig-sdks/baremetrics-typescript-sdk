...
import { SourceGetCustomerListResponseCustomersInner } from './source-get-customer-list-response-customers-inner';

/**
 * 
 * @export
 * @interface SourceGetCustomerListResponse
 */
export interface SourceGetCustomerListResponse {
    /**
     * 
     * @type {Array<SourceGetCustomerListResponseCustomersInner>}
     * @memberof SourceGetCustomerListResponse
     */
    'customers'?: Array<SourceGetCustomerListResponseCustomersInner>;
}
