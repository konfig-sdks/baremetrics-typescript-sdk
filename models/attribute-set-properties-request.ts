...
import { AttributeSetPropertiesRequestAttributesInner } from './attribute-set-properties-request-attributes-inner';

/**
 * 
 * @export
 * @interface AttributeSetPropertiesRequest
 */
export interface AttributeSetPropertiesRequest {
    /**
     * 
     * @type {Array<AttributeSetPropertiesRequestAttributesInner>}
     * @memberof AttributeSetPropertiesRequest
     */
    'attributes'?: Array<AttributeSetPropertiesRequestAttributesInner>;
}
