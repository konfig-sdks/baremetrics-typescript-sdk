...
import { UserListUsersResponseUsersInner } from './user-list-users-response-users-inner';

/**
 * 
 * @export
 * @interface UserListUsersResponse
 */
export interface UserListUsersResponse {
    /**
     * 
     * @type {Array<UserListUsersResponseUsersInner>}
     * @memberof UserListUsersResponse
     */
    'users'?: Array<UserListUsersResponseUsersInner>;
}
