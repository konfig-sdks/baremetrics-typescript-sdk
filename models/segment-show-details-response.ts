...
import { SegmentShowDetailsResponseSegment } from './segment-show-details-response-segment';

/**
 * 
 * @export
 * @interface SegmentShowDetailsResponse
 */
export interface SegmentShowDetailsResponse {
    /**
     * 
     * @type {SegmentShowDetailsResponseSegment}
     * @memberof SegmentShowDetailsResponse
     */
