 ...
 * 
 * @export
 * @interface SourceGetRefundsResponseRefundsInnerCustomer
 */
export interface SourceGetRefundsResponseRefundsInnerCustomer {
    /**
     * 
     * @type {string}
     * @memberof SourceGetRefundsResponseRefundsInnerCustomer
     */
    'oid'?: string;
    /**
     * 
