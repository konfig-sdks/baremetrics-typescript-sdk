...
import { MetricShowPlanBreakoutResponseMetricsInnerPlan } from './metric-show-plan-breakout-response-metrics-inner-plan';

/**
 * 
 * @export
 * @interface MetricShowPlanBreakoutResponseMetricsInner
 */
export interface MetricShowPlanBreakoutResponseMetricsInner {
    /**
     * 
     * @type {number}
     * @memberof MetricShowPlanBreakoutResponseMetricsInner
     */
    'date'?: number;
    /**
     * 
    ...
    /**
     * 
     * @type {MetricShowPlanBreakoutResponseMetricsInnerPlan}
     * @memberof MetricShowPlanBreakoutResponseMetricsInner
     */
    'plan'?: MetricShowPlanBreakoutResponseMetricsInnerPlan;
}
