...
import { SegmentCreateRequestRequestQueryInner } from './segment-create-request-request-query-inner';

/**
 * 
 * @export
 * @interface SegmentFindWithoutSaveRequest
 */
export interface SegmentFindWithoutSaveRequest {
    /**
     * 
     * @type {Array<SegmentCreateRequestRequestQueryInner>}
     * @memberof SegmentFindWithoutSaveRequest
     */
    'query': Array<SegmentCreateRequestRequestQueryInner>;
}
