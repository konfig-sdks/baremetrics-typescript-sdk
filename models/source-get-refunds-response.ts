...
import { SourceGetRefundsResponseRefundsInner } from './source-get-refunds-response-refunds-inner';

/**
 * 
 * @export
 * @interface SourceGetRefundsResponse
 */
export interface SourceGetRefundsResponse {
    /**
     * 
     * @type {Array<SourceGetRefundsResponseRefundsInner>}
     * @memberof SourceGetRefundsResponse
     */
    'refunds'?: Array<SourceGetRefundsResponseRefundsInner>;
}
