...
import { ReasonShowDetailsResponseReason } from './reason-show-details-response-reason';

/**
 * 
 * @export
 * @interface ReasonShowDetailsResponse
 */
export interface ReasonShowDetailsResponse {
    /**
     * 
     * @type {ReasonShowDetailsResponseReason}
     * @memberof ReasonShowDetailsResponse
     */
