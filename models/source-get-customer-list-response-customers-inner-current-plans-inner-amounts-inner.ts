 ...
 * 
 * @export
 * @interface SourceGetCustomerListResponseCustomersInnerCurrentPlansInnerAmountsInner
 */
export interface SourceGetCustomerListResponseCustomersInnerCurrentPlansInnerAmountsInner {
    /**
     * 
     * @type {string}
     * @memberof SourceGetCustomerListResponseCustomersInnerCurrentPlansInnerAmountsInner
     */
    'currency'?: string;
    /**
     * 
