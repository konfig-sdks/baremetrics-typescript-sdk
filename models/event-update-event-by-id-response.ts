...
import { EventUpdateEventByIdResponseEvent } from './event-update-event-by-id-response-event';

/**
 * 
 * @export
 * @interface EventUpdateEventByIdResponse
 */
export interface EventUpdateEventByIdResponse {
    /**
     * 
     * @type {EventUpdateEventByIdResponseEvent}
     * @memberof EventUpdateEventByIdResponse
     */
