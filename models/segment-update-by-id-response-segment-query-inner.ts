 ...
 * 
 * @export
 * @interface SegmentUpdateByIdResponseSegmentQueryInner
 */
export interface SegmentUpdateByIdResponseSegmentQueryInner {
    /**
     * 
     * @type {string}
     * @memberof SegmentUpdateByIdResponseSegmentQueryInner
     */
    'category'?: string;
    /**
     * 
