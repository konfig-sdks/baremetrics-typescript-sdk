 ...
 * 
 * @export
 * @interface SourceCreatePlanResponsePlanAmountsInner
 */
export interface SourceCreatePlanResponsePlanAmountsInner {
    /**
     * 
     * @type {string}
     * @memberof SourceCreatePlanResponsePlanAmountsInner
     */
    'currency'?: string;
    /**
     * 
