 ...
 * 
 * @export
 * @interface SourceCreateSubscriptionResponseEventInfoAddonsInner
 */
export interface SourceCreateSubscriptionResponseEventInfoAddonsInner {
    /**
     * 
     * @type {string}
     * @memberof SourceCreateSubscriptionResponseEventInfoAddonsInner
     */
    'oid'?: string;
    /**
     * 
