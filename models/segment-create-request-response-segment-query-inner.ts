 ...
 * 
 * @export
 * @interface SegmentCreateRequestResponseSegmentQueryInner
 */
export interface SegmentCreateRequestResponseSegmentQueryInner {
    /**
     * 
     * @type {string}
     * @memberof SegmentCreateRequestResponseSegmentQueryInner
     */
    'category'?: string;
    /**
     * 
