...
import { SourceCancelSubscriptionResponseEventInfo } from './source-cancel-subscription-response-event-info';

/**
 * 
 * @export
 * @interface SourceCancelSubscriptionResponseEvent
 */
export interface SourceCancelSubscriptionResponseEvent {
    /**
     * 
     * @type {SourceCancelSubscriptionResponseEventInfo}
     * @memberof SourceCancelSubscriptionResponseEvent
     */
