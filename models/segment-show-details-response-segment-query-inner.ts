 ...
 * 
 * @export
 * @interface SegmentShowDetailsResponseSegmentQueryInner
 */
export interface SegmentShowDetailsResponseSegmentQueryInner {
    /**
     * 
     * @type {string}
     * @memberof SegmentShowDetailsResponseSegmentQueryInner
     */
    'category'?: string;
    /**
     * 
