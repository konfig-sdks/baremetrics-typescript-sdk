 ...
 * 
 * @export
 * @interface SourceListCustomerEventsResponseEventsInner
 */
export interface SourceListCustomerEventsResponseEventsInner {
    /**
     * 
     * @type {string}
     * @memberof SourceListCustomerEventsResponseEventsInner
     */
    'id'?: string;
    /**
     * 
