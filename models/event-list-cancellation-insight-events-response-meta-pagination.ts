 ...
 * 
 * @export
 * @interface EventListCancellationInsightEventsResponseMetaPagination
 */
export interface EventListCancellationInsightEventsResponseMetaPagination {
    /**
     * 
     * @type {boolean}
     * @memberof EventListCancellationInsightEventsResponseMetaPagination
     */
    'has_more'?: boolean;
    /**
     * 
