...
import { SourceCreateSubscriptionResponseEvent } from './source-create-subscription-response-event';

/**
 * 
 * @export
 * @interface SourceCreateSubscriptionResponse
 */
export interface SourceCreateSubscriptionResponse {
    /**
     * 
     * @type {SourceCreateSubscriptionResponseEvent}
     * @memberof SourceCreateSubscriptionResponse
     */
