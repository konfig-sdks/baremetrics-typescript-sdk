 ...
 * 
 * @export
 * @interface MetricShowPlanBreakoutResponseMetricsInnerPlanAmountsInner
 */
export interface MetricShowPlanBreakoutResponseMetricsInnerPlanAmountsInner {
    /**
     * 
     * @type {string}
     * @memberof MetricShowPlanBreakoutResponseMetricsInnerPlanAmountsInner
     */
    'currency'?: string;
    /**
     * 
