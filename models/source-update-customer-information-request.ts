 ...
 * 
 * @export
 * @interface SourceUpdateCustomerInformationRequest
 */
export interface SourceUpdateCustomerInformationRequest {
    /**
     * 
     * @type {string}
     * @memberof SourceUpdateCustomerInformationRequest
     */
    'name'?: string;
    /**
     * 
