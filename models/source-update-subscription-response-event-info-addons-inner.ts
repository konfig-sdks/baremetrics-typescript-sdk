 ...
 * 
 * @export
 * @interface SourceUpdateSubscriptionResponseEventInfoAddonsInner
 */
export interface SourceUpdateSubscriptionResponseEventInfoAddonsInner {
    /**
     * 
     * @type {string}
     * @memberof SourceUpdateSubscriptionResponseEventInfoAddonsInner
     */
    'oid'?: string;
    /**
     * 
