...
import { SegmentCreateRequestResponseSegment } from './segment-create-request-response-segment';

/**
 * 
 * @export
 * @interface SegmentCreateRequestResponse
 */
export interface SegmentCreateRequestResponse {
    /**
     * 
     * @type {SegmentCreateRequestResponseSegment}
     * @memberof SegmentCreateRequestResponse
     */
