...
import { SourceGetPlanResponsePlan } from './source-get-plan-response-plan';

/**
 * 
 * @export
 * @interface SourceGetPlanResponse
 */
export interface SourceGetPlanResponse {
    /**
     * 
     * @type {SourceGetPlanResponsePlan}
     * @memberof SourceGetPlanResponse
     */
