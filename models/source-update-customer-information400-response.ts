 ...
 * 
 * @export
 * @interface SourceUpdateCustomerInformation400Response
 */
export interface SourceUpdateCustomerInformation400Response {
    /**
     * 
     * @type {string}
     * @memberof SourceUpdateCustomerInformation400Response
     */
    'error'?: string;
}
