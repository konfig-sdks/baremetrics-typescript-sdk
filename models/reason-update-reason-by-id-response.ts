...
import { ReasonUpdateReasonByIdResponseReason } from './reason-update-reason-by-id-response-reason';

/**
 * 
 * @export
 * @interface ReasonUpdateReasonByIdResponse
 */
export interface ReasonUpdateReasonByIdResponse {
    /**
     * 
     * @type {ReasonUpdateReasonByIdResponseReason}
     * @memberof ReasonUpdateReasonByIdResponse
     */
