 ...
 * 
 * @export
 * @interface EventUpdateEventByIdResponseEventCustomer
 */
export interface EventUpdateEventByIdResponseEventCustomer {
    /**
     * 
     * @type {string}
     * @memberof EventUpdateEventByIdResponseEventCustomer
     */
    'oid'?: string;
    /**
     * 
