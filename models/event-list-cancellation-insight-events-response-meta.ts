...
import { EventListCancellationInsightEventsResponseMetaPagination } from './event-list-cancellation-insight-events-response-meta-pagination';

/**
 * 
 * @export
 * @interface EventListCancellationInsightEventsResponseMeta
 */
export interface EventListCancellationInsightEventsResponseMeta {
    /**
     * 
     * @type {EventListCancellationInsightEventsResponseMetaPagination}
     * @memberof EventListCancellationInsightEventsResponseMeta
     */
