 ...
 * 
 * @export
 * @interface CancellationInsightCreateNewReasonResponseReason
 */
export interface CancellationInsightCreateNewReasonResponseReason {
    /**
     * 
     * @type {string}
     * @memberof CancellationInsightCreateNewReasonResponseReason
     */
    'id'?: string;
    /**
     * 
