 ...
 * 
 * @export
 * @interface CancellationInsightCreateNewReasonRequest
 */
export interface CancellationInsightCreateNewReasonRequest {
    /**
     * 
     * @type {string}
     * @memberof CancellationInsightCreateNewReasonRequest
     */
    'text': string;
    /**
     * 
