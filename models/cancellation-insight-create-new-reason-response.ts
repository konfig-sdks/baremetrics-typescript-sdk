...
import { CancellationInsightCreateNewReasonResponseReason } from './cancellation-insight-create-new-reason-response-reason';

/**
 * 
 * @export
 * @interface CancellationInsightCreateNewReasonResponse
 */
export interface CancellationInsightCreateNewReasonResponse {
    /**
     * 
     * @type {CancellationInsightCreateNewReasonResponseReason}
     * @memberof CancellationInsightCreateNewReasonResponse
     */
