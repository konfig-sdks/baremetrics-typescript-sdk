...
import { SegmentListSegmentsResponseSegmentsInner } from './segment-list-segments-response-segments-inner';

/**
 * 
 * @export
 * @interface SegmentListSegmentsResponse
 */
export interface SegmentListSegmentsResponse {
    /**
     * 
     * @type {Array<SegmentListSegmentsResponseSegmentsInner>}
     * @memberof SegmentListSegmentsResponse
     */
    'segments'?: Array<SegmentListSegmentsResponseSegmentsInner>;
}
