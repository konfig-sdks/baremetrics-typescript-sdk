 ...
 * 
 * @export
 * @interface EventCreateInsightEventResponseEventReason
 */
export interface EventCreateInsightEventResponseEventReason {
    /**
     * 
     * @type {string}
     * @memberof EventCreateInsightEventResponseEventReason
     */
    'id'?: string;
    /**
     * 
