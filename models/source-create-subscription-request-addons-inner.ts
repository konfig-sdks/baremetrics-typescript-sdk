 ...
 * 
 * @export
 * @interface SourceCreateSubscriptionRequestAddonsInner
 */
export interface SourceCreateSubscriptionRequestAddonsInner {
    /**
     * 
     * @type {string}
     * @memberof SourceCreateSubscriptionRequestAddonsInner
     */
    'oid': string;
    /**
     * 
