...
import { SourceListSourcesResponseSourcesInner } from './source-list-sources-response-sources-inner';

/**
 * 
 * @export
 * @interface SourceListSourcesResponse
 */
export interface SourceListSourcesResponse {
    /**
     * 
     * @type {Array<SourceListSourcesResponseSourcesInner>}
     * @memberof SourceListSourcesResponse
     */
    'sources'?: Array<SourceListSourcesResponseSourcesInner>;
}
