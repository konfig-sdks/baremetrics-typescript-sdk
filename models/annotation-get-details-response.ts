...
import { AnnotationGetDetailsResponseAnnotation } from './annotation-get-details-response-annotation';

/**
 * 
 * @export
 * @interface AnnotationGetDetailsResponse
 */
export interface AnnotationGetDetailsResponse {
    /**
     * 
     * @type {AnnotationGetDetailsResponseAnnotation}
     * @memberof AnnotationGetDetailsResponse
     */
