...
import { SegmentListSegmentsResponseSegmentsInnerQueryInner } from './segment-list-segments-response-segments-inner-query-inner';

/**
 * 
 * @export
 * @interface SegmentListSegmentsResponseSegmentsInner
 */
export interface SegmentListSegmentsResponseSegmentsInner {
    /**
     * 
     * @type {string}
     * @memberof SegmentListSegmentsResponseSegmentsInner
     */
    'id'?: string;
    /**
     * 
    ...
    /**
     * 
     * @type {Array<SegmentListSegmentsResponseSegmentsInnerQueryInner>}
     * @memberof SegmentListSegmentsResponseSegmentsInner
     */
    'query'?: Array<SegmentListSegmentsResponseSegmentsInnerQueryInner>;
    /**
     * 
     * @type {number}
     * @memberof SegmentListSegmentsResponseSegmentsInner
