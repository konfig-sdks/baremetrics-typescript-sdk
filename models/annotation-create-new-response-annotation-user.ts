 ...
 * 
 * @export
 * @interface AnnotationCreateNewResponseAnnotationUser
 */
export interface AnnotationCreateNewResponseAnnotationUser {
    /**
     * 
     * @type {string}
     * @memberof AnnotationCreateNewResponseAnnotationUser
     */
    'id'?: string;
    /**
     * 
