...
/**
 * This class provides a wrapper for network errors when making requests to Production
 */
export class BaremetricsError extends Error {
  /**
   * The response body
   */
